      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;">Hello ${param.name}</h1>
          </td>
        </tr>
        <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
              <tr>
                ...
                <td width="260" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
               		<tr>
               		<td> <img width = "250px" src="cid:a1" /> </td>
               		<td> 
			           <video width="250px" controls>
						  <source src="cid:a2" type="video/mp4">
                    ...
                    <tr>
                      <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 25px 0 0 0;">
                       		<h3> This is your informations</h3>
							<h4>Email Address:</h4> <p> ${param.email}</p>
							<h4>Phone Number :</h4> <p> ${param.phone}</p>
							<h4>User type :</h4> <p> ${param.type}</p>
							<h4>Description:</h4> <p> ${param.desc}</p>
                      </td>
                    </tr>
                  </table>
                </td>
