...
<body class="full-scale no-overflow">
	<div class="full-scale center">
		<form class="form-box" action="SaveAccount" method="post"
			...
			<div>
				<br> <input accept="image/*" type="file" name="image" size="50" />
			</div>
			<div>
				<br> <input accept="video/*" type="file" name="video" size="50" />
				<br>
			</div>
